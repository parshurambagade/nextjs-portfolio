 ...
 * @see https://v0.dev/t/rjjCCYoagVo
 */
...
export function Contact() {
  return (
    ...
    <div className="mx-auto container flex flex-col-reverse lg:flex-row max-w-2xl gap-8 py-2 items-center justify-center space-y-8 px-4 md:w-3/4 md:gap-12 lg:py-12 lg:space-y-12 xl:max-w-4xl xl:gap-16">
