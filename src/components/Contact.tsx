...
export function Contact() {
  ...
  return (
    <section id="contact" className="xl:mt-40 py-20 bg-black dark:bg-black dark:bg-dot-white/[0.2] bg-dot-white/[0.2] ">
    ...
    <div className="mx-auto container flex flex-col-reverse lg:flex-row max-w-2xl gap-8 py-2 items-center justify-center space-y-8 px-4 md:px-0 lg:px-4 md:w-3/4  md:gap-12 lg:py-12 lg:space-y-12 xl:max-w-4xl xl:gap-16">
      ...
      <div className="flex items-center justify-center w-max md:w-full lg:w-max md:my-4 lg:my-0 text-gray-400 dark:text-gray-400 ">
