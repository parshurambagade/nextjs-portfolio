...
export function Contact() {
  ...
  return (
    <section
      id="contact"
      className="xl:mt-40 py-20 bg-black dark:bg-black dark:bg-dot-white/[0.2] bg-dot-white/[0.2] "
    >
        ...
        <div className="w-full space-y-4 lg:w-3/4 px-4 lg:px-0">
          <div className="w-full space-y-4">
            ...
            <form
              ref={form}
              onSubmit={sendEmail}
              className="text-white w-full grid grid-cols-1 gap-2 lg:gap-4 "
            >
        ...
        <div className="flex items-center justify-center w-max md:w-full lg:w-max md:my-4 lg:my-0 text-gray-400 dark:text-gray-400 text-sm lg:text-base     ">
          <div className="w-full max-w-[300px] mx-auto md:max-w-full lg:max-w-max ">
            <div className="box-border w-full  flex flex-wrap  justify-evenly lg:mx-0 lg:justify-normal md:grid grid-cols-4 lg:grid-cols-1 gap-4 lg:gap-8 md:justify-center        ">
              <Link
                className="flex flex-1 items-center p-4 rounded-lg gap-4 bg-gray-800 lg:bg-transparent hover:bg-gray-800 dark:hover:bg-gray-800"
                href="https://www.linkedin.com/in/parshuram-bagade/"
              >
              ...
              <Link
                className="flex flex-1 items-center p-4 rounded-lg gap-4 bg-gray-800 lg:bg-transparent hover:bg-gray-800 dark:hover:bg-gray-800"
                href="mailto:parshuram.dev@outlook.com"
              >
